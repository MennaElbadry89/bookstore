    ...
    return(
         <div className='Footer flex flex-col w-full static bottom-0 left-0 bg-blue-50 z-[200]'>
            <div className="top w-full mx-auto">
                ...
                <div className="row mx-20 my-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                  ...
                  <div className="Login ">
                    ...
                    <div className="media flex flex-col items-center justify-center gap-2">
                                    <b className='text-blue-700 text-2xl'>Store Media </b>
                                    <ul className='flex text-4xl pt-5'>
                    ...
                    <div className="NEWSLETTER flex flex-col items-center justify-center gap-2">
                            <b className='text-blue-700 text-2xl'>NEWSLETTER</b>
                            <p>Get the latest books and offers directly to your inbox.</p>
            ...
            <hr className=' w-3/4 flex items-center justify-center text-gray-50'/>
            
            <div className="bottom w-full">
                  <div className="">
                    <div className="bottom max-md:flex-col my-5 mx-5 flex items-center justify-around gap-5">
                    <p>All rights reserved@ <a className='text-blue-700 font-bold' href="https://www.linkedin.com/in/menna-elbadry21/">Menna Elbadry</a> </p>
