    ...
    return(
        <>
         <div className="@container Regiser bg-white p-5 my-0">
            <h1 className="m-5 text-blue-500 text-3xl text-center font-semibold max-md:text-3xl">Login Now </h1>
        <div className="max-md:w-full w-1/2 m-auto flex items-center justify-center "> 
              <form onSubmit={handleSubmit(LoginSubmitHandler)}  className="flex flex-col justify-center gap-5 my-5 w-full bg-white p-5 border border-blue-300 rounded-lg shadow-lg ">
